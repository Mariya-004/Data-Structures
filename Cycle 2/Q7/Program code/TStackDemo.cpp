    ...
    while (choice=='y') {
		...
		if (opt==2){
            ...
            while (ch=='y') {
	            ...
	            if (op==5) {
	                cout<<"Peeking at the front element"<<endl;
	                float peeked=myStack.peek_front();
	                cout<<"Front element:"<<peeked<<endl;
	                cout<<endl;
	            }
	            if (op==6) {
	                cout<<"Peeking at the back element"<<endl;
	                float peeked=myStack.peek_back();
	                cout<<"Back element:"<<peeked<<endl;
	                cout<<endl;
	            }
	            if (op==7) {
		...
		if (opt==3){
            ...
            while (ch=='y') {
	            ...
	            if (op==5) {
	                cout<<"Peeking at the front element"<<endl;
	                char peeked=myStack.peek_front();
	                cout<<"Front element:"<<peeked<<endl;
	                cout<<endl;
	            }
	            if (op==6) {
	                cout<<"Peeking at the back element"<<endl;
	                char peeked=myStack.peek_back();
	                cout<<"Back element:"<<peeked<<endl;
	                cout<<endl;
	            }
	            if (op==7) {
