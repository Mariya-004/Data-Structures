...
int main(){
	...
	cout<<"Enter 9 to sort the array using quick sort"<<endl;
	cout<<"Enter 10 to sort the array using bubble sort"<<endl;
	cout<<"Enter 11 to sort the array using insertion sort"<<endl;
	cout<<"Enter 12 to sort the array using merge sort"<<endl;
	cout<<"Enter 13 to sort the array using selection sort"<<endl;
	cout<<"Enter 14 to perform binary search on array"<<endl;
	cout<<"Enter 15 to perform linear search on array"<<endl;
	cout<<"Enter 16 to perform left rotation on array"<<endl;
	cout<<"Enter 17 to perform right rotation on array"<<endl;
	cout<<"Enter 18 to print the frquency table of the array"<<endl;
	cout<<"Enter 19 to print the distinct elements of the array"<<endl;
	cout<<endl;
		...
		if (opt==1){
			...
			while(ch=='y'){
				...
				if (op==14){
					...
					cin>>ele;
					myArray.bubble_sort();
					int ind=myArray.binary_search(ele);
					if (ind==-1){
						cout<<"Element not found"<<endl;
					}
					else{
				...
				if (op==15){
					...
					int ele;
					cin>>ele;
					int ind=myArray.linear_search(ele);
					if (ind==-1){
						cout<<"Element not found"<<endl;
					}
					else{
