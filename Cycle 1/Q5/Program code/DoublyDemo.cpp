		...
		if (opt==1){
			...
			while(ch=='y'){
				...
				if (op==3){
					...
					int k;
					cin>>k;
					myLL.insert_at_pos(pos,k);
					cout<<"Element inserted"<<endl;
					cout<<endl;
				}
				if (op==4){
					cout<<"Deleting from beginning"<<endl;
					myLL.delete_from_front();
